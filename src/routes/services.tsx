  ...
  const categories = [
    {
      id: "facial", label: "Facial", items: [
        ...
        { title: "Microneedling Facial (3 Sessions)", duration: "1h 20min", price: "$500.00", desc: "3 sessions for optimal collagen.", link: "https://www.vagaro.com/cl/fLIDgC5Tg1ab8w8CQyTJzFZvx9wg~XNsFNcxcHa8HZI=", image: imgMicroNeedlingThree },
