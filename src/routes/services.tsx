  ...
  const categories = [
    {
      id: "facial", label: "Facial", items: [
        ...
        { title: "Microneedling Facial 1 Session .", duration: "90 MIN", price: "From$220.00", desc: "Flawless\u00A0 And Collagen Rich Skin\u00A0", link: "https://www.vagaro.com/cl/fLIDgC5Tg1ab8w8CQyTJzFZvx9wg~XNsFNcxcHa8HZI=", image: imgMicroNeedlingThree },
    ...
    },
    {
      id: "body", label: "Body", items: [
        ...
        { title: "Stretch Marks Treatment", duration: "60 min", price: "$480.00", desc: "Innovative Organic Peeling.", link: "https://www.vagaro.com/cl/Yntu9zt~P14280rGAZfrViuP52DiVNe4cnBsXQrqJrg=", image: imgStretchMarksTreatment },
        { title: "Body Wrap", duration: "80 MIN", price: "$140.00", desc: "Body Wrap Treatment\u00a0", link: "https://www.vagaro.com/cl/6q3d6i~hA0BKVLBEE~3MEMLxM2gFf1hICT~i6A06m9k=", image: imgBodyWrap },
                  ...
                  <a key={s.title} href={s.link} target="_blank" rel="noopener noreferrer" className="border border-gold/15 hover:border-gold transition-all flex flex-col group bg-card/30">
                    <div className="w-full h-80 overflow-hidden shrink-0">
                      <img 
                        src={s.image} 
                        alt={s.title} 
                        className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 ${s.title === 'Skin Assessment' ? 'object-[center_20%]' : 'object-[center_bottom]'}`} 
                      />
                    </div>
