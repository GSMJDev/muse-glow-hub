  ...
  const categories = [
    {
      id: "facial", label: "Facial", items: [
        ...
        { title: "Microneedling Facial 1 Session .", duration: "1h 20min", price: "$500.00", desc: "Flawless\u00A0 And Collagen Rich Skin\u00A0", link: "https://www.vagaro.com/cl/fLIDgC5Tg1ab8w8CQyTJzFZvx9wg~XNsFNcxcHa8HZI=", image: imgMicroNeedlingThree },
